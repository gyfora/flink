...
public class MapFileCheckpointWriter extends AbstractCheckpointWriter {
	...
	public MapFileCheckpointWriter(Path path, FileSystem fs)
			throws IOException {

		writer = new Writer(new Configuration(), path, Writer.keyClass(BytesWritable.class),
